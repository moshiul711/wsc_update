...
class SslCommerzPaymentController extends Controller
{
    ...
    public $orderInfo,$orderDetailsInfo;
        ...
        if ($order_details->order_status == 'pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                $this->orderDetailsInfo= OrderDetails::where(['order_id'=>$order_details->id])->first();
                return view('website.checkout.order-complete',[
                    'order' => $order_details,
                    'details' => $this->orderDetailsInfo
                ]);
            }
            ...
            $this->orderDetailsInfo= OrderDetails::where(['order_id'=>$order_details->id])->get();
            return view('website.checkout.order-complete',[
                'order' => $order_details,
                'details' => $this->orderDetailsInfo
            ]);
