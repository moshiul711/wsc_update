                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                            ...
                            @foreach($couriers as $courier)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('courier.edit',$courier->id) }}" class="btn btn-info" title="Sub Category Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="{{ route('courier.delete',$courier->id) }}" onclick="return confirm('Are you sure to delete this?')" class="btn btn-danger" title="Courier Delete">
