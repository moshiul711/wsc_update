                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('coupon.update',$coupon->id) }}" method="post">
                        ...
                        <div class="form-group">
                            <p>Coupon Code:</p>
                            <input type="text" value="{{ $coupon->code }}" class="form-control" id="inputName" name="code" placeholder="Coupon Code">
                        </div>

                        <div class="form-group">
                            <p>Coupon Amount:</p>
                            <input type="number" value="{{ $coupon->amount }}" class="form-control" name="amount" placeholder="Discount Amount">
                        </div>
