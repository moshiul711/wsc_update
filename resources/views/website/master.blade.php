                                    ...
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            <h6 class="mt-1 mb-0 fs-15 text-dark">
                                                <a href="{{ route('cart.show') }}" class="xm-title badge bg-success text-white fw-normal fs-12 badge-pill">
                                                    View Cart
                                                </a>
                                            </h6>
                                            <div class="ms-auto">
                                                <span class="xm-title badge bg-secondary text-white fw-normal fs-12 badge-pill">
                                                    <a id="cart_destroy" href="{{ route('cart.destroy') }}" class="showall-text text-white">Remove All</a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <ul class="side-menu ">
                        <li class="slide">
                            <a class="side-menu__item pt-2" href="#" style="text-align: center">
                                <img src="{{ asset('/') }}website/assets/icons/category.png" alt="" height="20">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#" title="{{ $category->name }}">
                                <img src="{{ asset($category->icon) }}" height="20" alt="">
