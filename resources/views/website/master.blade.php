...
<div id="global-loader"><img src="{{ asset('/') }}website/assets/images/loader.svg" class="loader-img" alt="Loader">
</div>
<div class="page">
    <div class="page-main">
        <div class="app-header header sticky">
            <div class="container-fluid main-container">
                <div class="d-flex"><a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar"
                                       href="#"></a><a class="logo-horizontal " href="{{ route('home') }}"><img
                            src="{{ asset('/') }}website/assets/images/logo.png" class="header-brand-img desktop-logo"
                            alt="logo"><img src="{{ asset('/') }}website/assets/images/logo.png"
                    ...
                    <div class="dropdown d-sm-block d-md-none d-xl-block d-none  d-flex shopping-cart"><a
                            href="#"> @if (!Session::get('customer_id'))<h6 class="text-white"><i
                                    class="fa fa-location-arrow"></i> Deliver To <br><b>Bangladesh</b></h6>@else<h6
                                class="text-white"><i class="fa fa-location-arrow"></i> Deliver
                                To<br><b>{{ Session('customer_city') }}</b></h6> @endif  </a></div>
                    <div class="main-header-center ms-6 d-none d-xl-block">
                        <form action="{{ route('product.search') }}" style="text-align: center">@csrf<input
                                class="form-control" name="search" placeholder="Search for results..." type="search">
                            <button class="btn" type="submit"><img
                                    src="{{ asset('/') }}website/assets/icons/search-btn.png" height="25px" width="25px"
                                    alt=""></button>
                        </form>
                    </div>
                    <div class="d-flex order-lg-2 ms-auto header-right-icons" style="text-align: center">
                        <div class="dropdown d-xl-none d-md-block d-none" style="text-align: center"><a href="#"
                            ...
                            <div class="dropdown-menu header-search dropdown-menu-start" style="text-align: center">
                                <div class=" header-search dropdown-menu-start">
                                    <form action="{{ route('product.search') }}">@csrf
                        ...
                        <div class="dropdown  d-flex shopping-cart pe-3">
                            <div id="master_cart"><a href="javascript:void(0);" class="nav-link icon text-center"
                                        ...
                                        class="badge bg-info header-badge bg-red">{{ Cart::count() }}</span></a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <div class="d-flex"><h6 class="mt-1 mb-0 fs-15 text-dark"><a
                                            ...
                                            <div class="ms-auto"><span
                                                    class="xm-title badge bg-secondary text-white fw-normal fs-12 badge-pill"><a
                                                        id="cart_destroy" href="{{ route('cart.destroy') }}"
                                                        class="showall-text text-white">Remove All</a></span></div>
                                        </div>
                                    </div> @foreach (Cart::content() as $item)
                                        <div class="header-dropdown-list cart-menu ps4 overflow-hidden"><a
                                                class="dropdown-item d-flex p-4"><span
                                                    class="avatar avatar-lg br-5 me-3 align-self-center cover-image"><img
                                                        src="{{ asset($item->options->image) }}" alt=""></span>
                                                <div class="wp-60 cart-desc mt-1"><p
                                                        class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">{{ $item->name }}</p>
                                                    <p class="fs-12 fw-300 lh-1 mb-0">Price: <span
                                                            class="text-green">{{ $item->price }}</span></p><span
                                                        class="fs-12 fw-300 lh-1 mb-0">Quantity: {{ $item->qty }}</span>
                                                </div>
                                                <div class="ms-auto text-end d-flex fs-16"><span
                                                        class="fs-16 text-dark d-none d-sm-block fw-semibold">{{ round($item->price*$item->qty) }}</span>
                                                </div>
                                            </a></div> @endforeach
                                    ...
                                    <div class="dropdown-item d-flex p-4">
                                        ...
                                        <div class="ms-auto text-end d-flex fs-16"><span
                                                class="fs-16 text-dark d-none d-sm-block fw-semibold">{{ round(Cart::subtotal()) }}</span>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                                    <div class="text-center p-3"><a href="{{ route('cart.show') }}"
                                                                    class="btn btn-success">View Cart</a><a
                                            href="{{ route('checkout') }}" class="btn btn-danger right">Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="dropdown  d-flex shopping-cart  py-2"><a href="#"
                                        ...
                                        <div class="dropdown d-md-flex profile-1"><a href="#" data-bs-toggle="dropdown"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"><a
                                                    class="dropdown-item" href="{{ route('customer.profile') }}">
                                                    ...
                                                    </svg>{{Session('customer_name')}}</a><a class="dropdown-item"
                                                                                             href="{{ route('customer') }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-inner-icn"
                                                         enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                                        <path
        ...
        <div class="sticky">
            ...
            <div class="app-sidebar">
                <div class="side-header"><a class="header-brand1" href="{{ route('home') }}"><img
                            src="{{ asset('/') }}website/assets/images/logo.png" class="header-brand-img desktop-logo"
                            alt="logo"><img src="{{ asset('/') }}website/assets/images/logo1.png"
                                            class="header-brand-img toggle-logo" alt="logo"><img
                            src="{{ asset('/') }}website/assets/images/logo1.png" class="header-brand-img light-logo"
                            alt="logo"><img src="{{ asset('/') }}website/assets/images/logo.png"
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu ">
                        <li class="slide"><a class="side-menu__item pt-2" href="#" style="text-align: center"><img
                                    src="{{ asset('/') }}website/assets/icons/category.png" alt="" height="20"><span
                            ...
                            <li class="slide"><a class="side-menu__item" data-bs-toggle="slide" href="#"
                                                 title="{{ $category->name }}"><img src="{{ asset($category->icon) }}"
                                                                                    height="20" alt=""><span
                                        class="side-menu__label px-2">{{ $category->name }}</span> @if (count($category->subCategories)>0)
                                        <i class="angle fa fa-angle-right"></i> @endif  </a>
                                <ul class="slide-menu"> @foreach ($category->subCategories as $subCategory)
                                        <li><a href="{{ route('product.subcategory',['slug'=>$subCategory->name]) }}"
                                               class="slide-item">{{ $subCategory->name }}</a></li> @endforeach
                                    <li><a href="{{ route('product.category',['name'=>$category->name]) }}">All
                                            Products</a></li>
                                </ul>
                            </li> @endforeach  </ul>
        ...
        <div class="app-content main-content mt-0">
            <div class="side-app">
                <div class="main-container container"> @if  (session('message'))
                        <script>Swal.fire({
                                position: "top-end",
                                icon: "success",
                        ...
                        <script>const Toast = Swal.mixin({
                            ...
                            Toast.fire({icon: 'error', title: "{{ session('logout') }}"})</script>@ elseif
                        (session('error'))
                        <script>Swal.fire({
                                icon: "error",
                                title: "Oops...",
                        ...
                        <script>Swal.fire({
                                ...
                                icon: "success",
                                timer: 5000
                            });</script>  @endif   @yield('slider') @yield('discount') @yield('after-slider') @yield('main-content')
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <div class="col-lg-4 col-md-12"><h6>About</h6>
                                                ...
                                                <ul class="footer-social-list" style="text-align: center">
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="{{ asset('/') }}website/assets/icons/facebook.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="{{ asset('/') }}website/assets/icons/instagram.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="{{ asset('/') }}website/assets/icons/youtube.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="{{ asset('/') }}website/assets/icons/linkedin.png"
                                                                alt=""></a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 footer1 text-center text-lg-bold">
                                                Copyright © {{ date('Y') }}. All Rights Reserved By<a
                                                    href="{{ route('home') }}"> Workstation Communication</a></div>
                                        </div>
                                    </footer>
                                </div>
                            </div>
...
@include('website.wsc_js')
@include('website.cartModal')
</body>
</html>
