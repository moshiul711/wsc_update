<div class="modal fade" id="generateOtp">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content text-white">
            ...
            <form id="generateOtpForm">@csrf
                <div class="modal-body"><span class="login100-form-title"><a href="{{ route('home') }}"
                                                                             class="text-center"><img
                                src="{{ asset('/') }}website/assets/images/logo.png" class="header-brand-img" alt=""
...
<div class="modal fade" id="smallmodal">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content text-white">
            ...
            <form action="{{ route('customer.login') }}" method="post">@csrf
                <div class="modal-body"><span class="login100-form-title"><a href="{{ route('home') }}"
                                                                             class="text-center"><img
                                src="{{ asset('/') }}website/assets/images/logo.png" class="header-brand-img" alt=""
                                style="color: red"></a></span>
                    ...
                    <div class="text-end pt-1"><p class="mb-0 text-white"><a href="{{ route('forgot-password') }}"
...
<div class="modal fade" id="refer">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="background-color: white">
            ...
            <div class="modal-body" style="text-align: center"><img src="{{ asset('/') }}website/assets/icons/refer.gif"
        ...
        <div class="modal-content text-white">
            ...
            <form action="{{ route('customer.register') }}" method="post">@csrf
                <div class="modal-body"><span class="login100-form-title"><a href="#" class="text-center"><img
                                src="{{ asset('/') }}website/assets/images/logo.png" class="header-brand-img"
                                alt=""></a></span>
...
<script src="http://cdn.bootcss.com/toastr.js/latest/js/toastr.min.js"></script>{!! Toastr::message() !!}
...
<script>$('.quick-view').click(function () {
    ...
    function deliveryFee(address) {
        $.ajax({
            url: "{{ route('delivery') }}", method: "get", data: {address: address}, success: function (res) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#btnCart', function (e) {
            ...
            let id = $(this).data('id');
            $.ajax({
                url: "{{route('cart.add') }}", method: "get", data: {id: id, qty: qty}, success: function (res) {
        ...
        $(document).on('click', '#cart_destroy', function (e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('cart.destroy') }}", method: "get", success: function (res) {
                    $('#master_cart').load(window.location.href + '   #master_cart');
        ...
        $(document).on('click', '#remove_cart_product', function (e) {
            ...
            let rowId = $(this).data('id');
            $.ajax({
                url: "{{ route('cart.delete') }}", method: "get", data: {id: rowId}, success: function (res) {
