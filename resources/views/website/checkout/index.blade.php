                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(isset($customer->phone))
                                            <input type="tel" value="{{ $customer->phone }}" name="phone"
                                                   class="form-control" placeholder="Phone" max="14">
                                        @else
                                            <input type="tel" name="phone" value="{{ old('phone') }}" max="14" required class="form-control"
                                                   placeholder="Phone">
                                        @endif
                                    </div>
                                    @error('phone')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(isset($customer->city))
                                            <select name="city" class="form-control"
                                                ...
                                                <option {{ $customer->city == 'dhaka'?'selected':'' }} value="dhaka">
                                                    Dhaka
                                                </option>
                                                <option
                                                    {{ $customer->city == 'chittagong'?'selected':'' }} value="chittagong">
                                                    Chittagong
                                                </option>
                                                <option
                                                    {{ $customer->city == 'rajshahi'?'selected':'' }} value="rajshahi">
                                                    Rajshahi
                                                </option>
                                                <option {{ $customer->city == 'khulna'?'selected':'' }} value="khulna">
                                                    Khulna
                                                </option>
                                                <option
                                                    {{ $customer->city == 'barishal'?'selected':'' }} value="barishal">
                                                    Barishal
                                                </option>
                                                <option
                                                    {{ $customer->city == 'mymensingh'?'selected':'' }} value="mymensingh">
                                                    Mymensingh
                                                </option>
                                                <option
                                                    {{ $customer->city == 'rongpur'?'selected':'' }} value="rongpur">
                                                    Rongpur
                                                </option>
                                                <option {{ $customer->city == 'sylhet'?'selected':'' }} value="sylhet">
                                                    Sylhet
                                                </option>
                                            </select>
                                        @else
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @else
                                            <textarea class="form-control" placeholder="Home Address" name="address">{{ old('address') }}</textarea>
                                        @endif
                                    </div>
                                    @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                ...
                <div class="col-xl-5 col-md-5">
                    ...
                    <div class="card cart">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="d-md-flex">
                                        <div class="d-flex py-2">
                                            <img class="img-fluid avatar-xl border p-0 br-7"
                                                 src="{{ asset($item->options->image) }}" alt="img">
                                            <div class="ms-3 mt-2">
                                                <h4 class="mb-1 fw-semibold fs-14"><a
                                                        href="{{ route('product.detail',[$item->id,$item->name]) }}">{{ $item->name }}</a>
                                                </h4>
                                                <p class="fs-12 fw-300 lh-1 mb-0">Price: <span
                                                        class="text-green">{{ $item->price }}</span></p>
                                        ...
                                        <div class="ms-auto my-auto">
                                            <span
                                                class="me-4 my-auto fs-16 fw-semibold">Tk.{{ $item->qty*$item->price }}</span>
                                        </div>
                                    </div>
                                @endforeach
                                <table class="table mt-5">
                                    <tr>
                                        ...
                                        <td class="text-end border-top-0">
                                            Tk. {{ $subTotal = round(Cart::subtotal()) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end fs-20 border-top-0">
                                            Tk. {{ $payable = round($subTotal+$delivery - $discount) }}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            I have read and agree to the website <a href="{{ route('terms') }}" target="_blank">terms
                                and conditions</a> & <a href="{{ route('refund') }}" target="_blank">Return & Refund
                                Policy</a>
                        </div>
                        <?php
