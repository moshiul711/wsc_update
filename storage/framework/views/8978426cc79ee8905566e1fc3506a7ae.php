                ...
                <div class="row mb-5">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12">
                        ...
                        <div class="text-warning rating-container d-sm-flex">
                            <div class="ms-2">
                                <span>
                                    <a style="color: #00cc00; font-size: 18px">
                                        <i class="fa fa-line-chart"></i> <?php echo e($product->hit_count); ?> View(s)
                                    </a>
                                    ...
                                    <?php if($product->stock > 0): ?>
                                        <a class="px-1" style="color: #008069; font-size: 18px">
                                            <i class=" fa fa-cubes"></i> In Stock
                                        </a>
                                    <?php else: ?>
                                        <a class="px-1 text-danger" style="color: #008069; font-size: 18px">
                                            <i class=" fa fa-cubes"></i>Out of Stock
                                        </a>
                                    <?php endif; ?>
                                </span>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\wsc\resources\views/website/product/quick-view.blade.php ENDPATH**/ ?>