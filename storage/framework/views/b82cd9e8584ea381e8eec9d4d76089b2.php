...
<?php endif; ?>
                    ...
                    <form class="login100-form validate-form" action="<?php echo e(route('login')); ?>" method="post">
                        ...
                        <div class="text-center pt-3">
                            <p class="text-dark mb-0">Not a member?<a href="<?php echo e(route('register')); ?>" class="text-primary ms-1">Create an Account</a></p>
                        </div>
                    </form>
                </div>
...
<?php /**PATH D:\Xampp\htdocs\bangladeshTechCom\resources\views/auth/login.blade.php ENDPATH**/ ?>