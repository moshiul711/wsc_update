                            ...
                            <tbody>
                                <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" required name="quantity" min="1" max="<?php echo e($item->options->max); ?>" placeholder="0" class="form-control text-center" value="<?php echo e($item->qty); ?>" >
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(route('cart.delete',$item->rowId)); ?>" class="text-bold btn btn-danger-gradient me-1">Delete</a>
                                        </td>
                                    </tr>
                                    </form>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moshi\Downloads\New folder\wsc\resources\views/website/cart/show.blade.php ENDPATH**/ ?>