...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="row">
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"><?php echo e($order['visitor']); ?></h3>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"> <?php echo e(($order['order_count'])); ?></h3>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"><?php echo e(number_format($order['order_total'])); ?></h3>
        ...
        <?php if($order['order_count'] > 0): ?>
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"><?php echo e(number_format($order['order_total']/($order['order_count']))); ?></h3>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"><?php echo e(count(($order['users']))); ?></h3>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold"><?php echo e(count(($order['products']))); ?></h3>
        ...
        <div class="col-12 col-sm-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title mb-0">Orders Of <?php echo e(date('d-m-Y')); ?></h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('user.delete',$user->id)); ?>" onclick="return confirm('Are you sure to delete this?')" class="btn btn-danger-gradient">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/admin/home/index.blade.php ENDPATH**/ ?>