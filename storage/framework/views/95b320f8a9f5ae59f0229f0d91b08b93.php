        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2023. <a href="#"> All rights reserved by Bangladesh Technology Company.</a>
                </div>
            </div>
        </div>
    </footer>
...
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/p-scroll/pscroll.js"></script>
...
<!-- APEXCHART JS -->
<script src="<?php echo e(asset('/')); ?>admin/assets/js/apexcharts.js"></script>

<!-- INTERNAL SELECT2 JS -->
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/select2/select2.full.min.js"></script>

<!-- CHART-CIRCLE JS-->
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/circle-progress/circle-progress.min.js"></script>
...
<!-- INDEX JS -->
<script src="<?php echo e(asset('/')); ?>admin/assets/js/index1.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/js/index.js"></script>

<!-- Reply JS-->
<script src="<?php echo e(asset('/')); ?>admin/assets/js/reply.js"></script>
...
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/dataTables.buttons.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/buttons.bootstrap5.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/jszip.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/pdfmake/pdfmake.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/pdfmake/vfs_fonts.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/buttons.html5.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/buttons.print.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/js/buttons.colVis.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/dataTables.responsive.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/plugins/datatable/responsive.bootstrap5.min.js"></script>
<script src="<?php echo e(asset('/')); ?>admin/assets/js/table-data.js"></script>
...
<?php /**PATH D:\Xampp\htdocs\bangladeshTechCom\resources\views/layouts/app.blade.php ENDPATH**/ ?>