...
<?php $__env->startSection('main-content'); ?>
    <div class="page-header">
        ...
        <div class="col-md-2">
            <a href="<?php echo e(route('admin.order-invoice', ['id' => $order->order_number])); ?>" class="px-5" target="_blank"title="Order Invoice">
                <img src="<?php echo e(asset('/')); ?>website/assets/icons/invoice.png" alt="">
            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/admin/order/orderDetail.blade.php ENDPATH**/ ?>