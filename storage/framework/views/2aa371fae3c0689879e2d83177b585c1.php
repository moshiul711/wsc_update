            ...
            <div class="wrap-login100 p-0">
                <div class="card-body">
                    ...
                    <div class="text-center text-danger" >
                        <p class="text-lg text-bold"><?php echo e(Session('message')); ?></p>
                    </div>

                    <form class="login100-form validate-form" action="<?php echo e(route('forgot-password')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/website/home/forgotPassword.blade.php ENDPATH**/ ?>