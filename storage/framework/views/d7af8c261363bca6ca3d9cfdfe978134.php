                            ...
                            <div class="text-warning rating-container d-sm-flex">
                                <div class="ms-2">
                                    <span>
                                        ...
                                        <?php else: ?><a class="px-1 text-danger" style="color: #008069; font-size: 18px"><i class=" fa fa-cubes"></i>Out of Stock</a>
                                            <?php endif; ?>
                                    </span>
                                </div>
                            </div>
                                    ...
                                    <form action="<?php echo e(route('cart.add',$product->id)); ?>" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                <input type="number" class="form-control" required placeholder="Enter Product Quantity" value="1" min="1" max="<?php echo e($product->stock); ?>"  name="qty" id="quantity">
                                            </div>
                                            <div class="col-md-6 form-group">
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\moshi\Downloads\New folder\wsc\resources\views/website/product/detail.blade.php ENDPATH**/ ?>