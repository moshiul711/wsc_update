                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12 text-center">
                                    <label class="p-2">
                                        ...
                                        <img src="<?php echo e(asset('/')); ?>website/assets/icons/cod_icon.webp" alt="" style="height: 50px">
                                    </label>
                                    <label class="p-2">
                                        <input name="payment" required type="radio" value="online">
                                        <img src="<?php echo e(asset('/')); ?>website/assets/icons/cards_icon.webp" alt="" style="height: 50px">
                                    </label>
                                </div>
                            </div>
                        </div>
