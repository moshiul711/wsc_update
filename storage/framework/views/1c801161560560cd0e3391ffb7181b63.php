        ...
        <div id="carousel-controls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" alt="" src="<?php echo e(asset('/')); ?>website/assets/icons/s.jpg" data-bs-holder-rendered="true">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt="" src="<?php echo e(asset('/')); ?>website/assets/icons/s01.webp" data-bs-holder-rendered="true">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt="" src="<?php echo e(asset('/')); ?>website/assets/icons/s02.webp" data-bs-holder-rendered="true">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt="" src="<?php echo e(asset('/')); ?>website/assets/icons/s03.webp" data-bs-holder-rendered="true">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" alt="" src="<?php echo e(asset('/')); ?>website/assets/icons/s04.webp" data-bs-holder-rendered="true">
                </div>
            </div>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6"  style="background-color: red; border: 1px solid">
                                <a href="<?php echo e(route('product-details')); ?>" class="img-container" target="_blank">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/icons/p1.jpg" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                                            <a href="<?php echo e(route('product-details')); ?>" target="_blank" data-tip="Quick View">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('cart.show')); ?>" data-tip="Add to Cart" target="_blank">
                            ...
                            <div class="product-content w-100 p-3">
                                <div class="mb-2">
                                    <h4 class="mb-1 text-normal"><a href="<?php echo e(route('product-details')); ?>" target="_blank">Crimping Tool For RJ45 & RJ11</a> </h4>
                        ...
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/icons/p3.jpg" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/icons/p4.jpg" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/icons/p5.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/images/pngs/5.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/images/pngs/3.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/images/pngs/9.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
                ...
                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-3 product-each">
                    <div class="card item-card">
                        <div class="product-grid6 card-body">
                            <div class="product-image6">
                                <a href="product-details.html" class="img-container">
                                    <img class="img-fluid" src="<?php echo e(asset('/')); ?>website/assets/images/pngs/1.png" alt="img">
                                </a>
                                <div class="icon-container">
                                    <ul class="icons">
                                        <li>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\bangladeshTechCom\resources\views/website/home/review.blade.php ENDPATH**/ ?>