...
<?php $__env->startSection('main-content'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <img src="<?php echo e(asset('/')); ?>website/assets/icons/contact1.png" alt="">
        </div>
        <div class="col-md-6">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('contact.message')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/website/home/contact.blade.php ENDPATH**/ ?>