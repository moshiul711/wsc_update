...
<?php endif; ?>
                    ...
                    <form class="login100-form validate-form" action="<?php echo e(route('update-password',$customer->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/website/home/changePassword.blade.php ENDPATH**/ ?>