...
<head>
    ...
    <meta name="description"
          content="Workstation Communication Limited. Networking Products Supplier. Workstation Business Gateway">
    <meta name="author" content="Workstation Communication Limited">
    <meta name="image" content="Workstation Communication Limited">
    <meta name="keywords"
          content="splicer, ai 10, comway, a3+, pon, 9db, splitter Network, network, networking, networking product, patchcord, optical, olt, machine, signal fire,">
...
<div id="global-loader"><img src="<?php echo e(asset('/')); ?>website/assets/images/loader.svg" class="loader-img" alt="Loader">
</div>
<div class="page">
    <div class="page-main">
        <div class="app-header header sticky">
            <div class="container-fluid main-container">
                <div class="d-flex"><a aria-label="Hide Sidebar" class="app-sidebar__toggle" data-bs-toggle="sidebar"
                                       href="#"></a><a class="logo-horizontal " href="<?php echo e(route('home')); ?>"><img
                            src="<?php echo e(asset('/')); ?>website/assets/images/logo.png" class="header-brand-img desktop-logo"
                            alt="logo"><img src="<?php echo e(asset('/')); ?>website/assets/images/logo.png"
                                            class="header-brand-img light-logo1" alt="logo"></a>
                    <div class="dropdown d-sm-block d-md-none d-xl-block d-none  d-flex shopping-cart"><a
                            href="#"> <?php if(!Session::get('customer_id')): ?><h6 class="text-white"><i
                                    class="fa fa-location-arrow"></i> Deliver To <br><b>Bangladesh</b></h6><?php else: ?><h6
                                class="text-white"><i class="fa fa-location-arrow"></i> Deliver
                                To<br><b><?php echo e(Session('customer_city')); ?></b></h6> <?php endif; ?>  </a></div>
                    <div class="main-header-center ms-6 d-none d-xl-block">
                        <form action="<?php echo e(route('product.search')); ?>" style="text-align: center"><?php echo csrf_field(); ?><input
                                class="form-control" name="search" placeholder="Search for results..." type="search">
                            <button class="btn" type="submit"><img
                                    src="<?php echo e(asset('/')); ?>website/assets/icons/search-btn.png" height="25px" width="25px"
                                    alt=""></button>
                        </form>
                    </div>
                    <div class="d-flex order-lg-2 ms-auto header-right-icons" style="text-align: center">
                        <div class="dropdown d-xl-none d-md-block d-none" style="text-align: center"><a href="#"
                                                                                                        class="nav-link icon"
                            ...
                            <div class="dropdown-menu header-search dropdown-menu-start" style="text-align: center">
                                <div class=" header-search dropdown-menu-start">
                                    <form action="<?php echo e(route('product.search')); ?>"><?php echo csrf_field(); ?>
                        ...
                        <div class="dropdown  d-flex shopping-cart pe-3">
                            <div id="master_cart"><a href="javascript:void(0);" class="nav-link icon text-center"
                                                     data-bs-toggle="dropdown" aria-expanded="false"><i
                                        class="fa fa-shopping-cart text-white"></i><span
                                        class="badge bg-info header-badge bg-red"><?php echo e(Cart::count()); ?></span></a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex"><h6 class="mt-1 mb-0 fs-15 text-dark"><a
                                                    href="<?php echo e(route('cart.show')); ?>"
                                                    class="xm-title badge bg-success text-white fw-normal fs-12 badge-pill">View
                                                    Cart</a></h6>
                                            <div class="ms-auto"><span
                                                    class="xm-title badge bg-secondary text-white fw-normal fs-12 badge-pill"><a
                                                        id="cart_destroy" href="<?php echo e(route('cart.destroy')); ?>"
                                                        class="showall-text text-white">Remove All</a></span></div>
                                        </div>
                                    </div> <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="header-dropdown-list cart-menu ps4 overflow-hidden"><a
                                                class="dropdown-item d-flex p-4"><span
                                                    class="avatar avatar-lg br-5 me-3 align-self-center cover-image"><img
                                                        src="<?php echo e(asset($item->options->image)); ?>" alt=""></span>
                                                <div class="wp-60 cart-desc mt-1"><p
                                                        class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500"><?php echo e($item->name); ?></p>
                                                    <p class="fs-12 fw-300 lh-1 mb-0">Price: <span
                                                            class="text-green"><?php echo e($item->price); ?></span></p><span
                                                        class="fs-12 fw-300 lh-1 mb-0">Quantity: <?php echo e($item->qty); ?></span>
                                                </div>
                                                <div class="ms-auto text-end d-flex fs-16"><span
                                                        class="fs-16 text-dark d-none d-sm-block fw-semibold"><?php echo e(round($item->price*$item->qty)); ?></span>
                                                </div>
                                            </a></div> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <div class="dropdown-divider m-0"></div>
                                    <div class="dropdown-item d-flex p-4">
                                        <div class="wp-60 cart-desc mt-1"><p
                                                class="fs-13 mb-0 lh-1 mb-1 text-dark fw-500">Total</p></div>
                                        <div class="ms-auto text-end d-flex fs-16"><span
                                                class="fs-16 text-dark d-none d-sm-block fw-semibold"><?php echo e(round(Cart::subtotal())); ?></span>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
                                    <div class="text-center p-3"><a href="<?php echo e(route('cart.show')); ?>"
                                                                    class="btn btn-success">View Cart</a><a
                                            href="<?php echo e(route('checkout')); ?>" class="btn btn-danger right">Checkout</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                <div class="d-flex order-lg-2">
                                    <div class="dropdown d-md-none d-flex">
                                        <div class=" header-search dropdown-menu-start">
                                            <form action="<?php echo e(route('product.search')); ?>"><?php echo csrf_field(); ?>
                                                <div class="input-group w-75 p-2"><input type="text"
                                                                                         class="form-control"
                                                                                         name="search"
                                    ...
                                    <div class="dropdown  d-flex shopping-cart  py-2"><a href="#"
                                                                                         data-bs-target="#refer"
                                                                                         data-bs-toggle="modal"><h6
                                                class="text-white">Refer <br><b>& Win</b></h6></a>
                                    </div> <?php if(!Session::get('customer_id')): ?>
                                        <div class="dropdown d-md-flex profile-1 mx-4"><a href="#"
                                                                                          data-bs-target="#smallmodal"
                                                                                          data-bs-toggle="modal"><h6
                                                    class="text-white">Hello <br><b>User</b></h6></a></div><?php else: ?>
                                        <div class="dropdown d-md-flex profile-1"><a href="#" data-bs-toggle="dropdown"
                                                                                     class="nav-link pe-2 leading-none d-flex animate">
                                                <h6 class="text-white">
                                                    Hello<br><b><?php echo e(Str::limit(Session('customer_name'),8)); ?></b></h6>
                                                <div class="text-center p-1 d-flex d-lg-none-max"><h6
                                                        class="mb-0 text-bold text-white" id="profile-heading"></h6>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow"><a
                                                    class="dropdown-item" href="<?php echo e(route('customer.profile')); ?>">
                                                    ...
                                                    </svg><?php echo e(Session('customer_name')); ?></a><a class="dropdown-item"
                                                    ...
                                                    DashBoard</a><a class="dropdown-item"
        ...
        <div class="sticky">
            ...
            <div class="app-sidebar">
                <div class="side-header"><a class="header-brand1" href="<?php echo e(route('home')); ?>"><img
                            src="<?php echo e(asset('/')); ?>website/assets/images/logo.png" class="header-brand-img desktop-logo"
                            alt="logo"><img src="<?php echo e(asset('/')); ?>website/assets/images/logo1.png"
                                            class="header-brand-img toggle-logo" alt="logo"><img
                            src="<?php echo e(asset('/')); ?>website/assets/images/logo1.png" class="header-brand-img light-logo"
                            alt="logo"><img src="<?php echo e(asset('/')); ?>website/assets/images/logo.png"
                                            class="header-brand-img light-logo1" alt="logo"></a><!-- LOGO --></div>
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu ">
                        <li class="slide"><a class="side-menu__item pt-2" href="#" style="text-align: center"><img
                                    src="<?php echo e(asset('/')); ?>website/assets/icons/category.png" alt="" height="20"><span
                                    class="side-menu__label px-2">Categories</span></a>
                        </li> <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="slide"><a class="side-menu__item" data-bs-toggle="slide" href="#"
                                                 title="<?php echo e($category->name); ?>"><img src="<?php echo e(asset($category->icon)); ?>"
                                                                                    height="20" alt=""><span
                                        class="side-menu__label px-2"><?php echo e($category->name); ?></span> <?php if(count($category->subCategories)>0): ?>
                                        <i class="angle fa fa-angle-right"></i> <?php endif; ?>  </a>
                                <ul class="slide-menu"> <?php $__currentLoopData = $category->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(route('product.subcategory',['slug'=>$subCategory->name])); ?>"
                                               class="slide-item"><?php echo e($subCategory->name); ?></a></li> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('product.category',['name'=>$category->name])); ?>">All
                                            Products</a></li>
                                </ul>
        ...
        <div class="app-content main-content mt-0">
            <div class="side-app">
                <div class="main-container container"> <?php if(session('message')): ?>
                        <script>Swal.fire({
                                position: "top-end",
                                icon: "success",
                        ...
                        <script>const Toast = Swal.mixin({
                            ...
                            Toast.fire({icon: 'error', title: "<?php echo e(session('logout')); ?>"})</script>@ elseif
                        (session('error'))
                        <script>Swal.fire({
                                icon: "error",
                                title: "Oops...",
                                ...
                                timer: 5000,
                            })</script>@ elseif  (session('contact'))
                        <script>Swal.fire({
                                title: "Good job!",
                                text: "<?php echo e(session('contact')); ?>",
                                icon: "success",
                                timer: 5000
                            });</script>  <?php endif; ?>   <?php echo $__env->yieldContent('slider'); ?> <?php echo $__env->yieldContent('discount'); ?> <?php echo $__env->yieldContent('after-slider'); ?> <?php echo $__env->yieldContent('main-content'); ?>
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="margin-bottom: 0.1rem ">
                                <div class="card-body">
                                    <div class="top-footer">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-12"><h6>About</h6>
                                                <p>Workstation Communication has 5 years professional experience in
                                                    selling Cisco, MikroTik, Juniper, Netgear and others ISP grade
                                                    hardware, offering better pre-sale and after-sale support,
                                                    solutions, which attracted more than 500+ Buyers internet service
                                                    provider, IIG, IGW and call center all over the Bangladesh</p>
                                                <ul class="footer-social-list" style="text-align: center">
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="<?php echo e(asset('/')); ?>website/assets/icons/facebook.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="<?php echo e(asset('/')); ?>website/assets/icons/instagram.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="<?php echo e(asset('/')); ?>website/assets/icons/youtube.png"
                                                                alt=""></a></li>
                                                    <li><a href="javascript:void(0);" class="social-icon"><img
                                                                src="<?php echo e(asset('/')); ?>website/assets/icons/linkedin.png"
                                                                alt=""></a></li>
                                                </ul>
                                            </div>
                                            <div class="col-6 col-lg-2 col-md-12"><h6>Pages</h6>
                                            ...
                                            <div class="col-6 col-lg-2 col-md-6 col-sm-6"><h6>Information</h6>
                                                <ul class="list-unstyled mb-4">
                                                    <li><a href="#" data-bs-target="#smallmodal" data-bs-toggle="modal">Login</a>
                                                    </li>
                                                    <li><a href="#" data-bs-target="#registration"
                                                           data-bs-toggle="modal">Registration</a></li>
                                                    <li><a href="<?php echo e(route('delivery')); ?>">Delivery Policy</a></li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-6"><h6>Location</h6>
                                                <ul class="list-unstyled mb-4">
                                                    <li><a href="javascript:void(0);">House #02, Road #03, Sector
                                                            #13</a></li>
                                                    ...
                                                    <li><a href="javascript:void(0);">Mail: info@workstation.com.bd</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <footer class="main-footer ps-3 pe-3">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 footer1 text-center text-lg-bold">
                                                Copyright © <?php echo e(date('Y')); ?>. All Rights Reserved By<a
                                                    href="<?php echo e(route('home')); ?>"> Workstation Communication</a></div>
                                        </div>
                                    </footer>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\wsc\resources\views/website/master.blade.php ENDPATH**/ ?>