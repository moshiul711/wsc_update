...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php if(isset($_GET['month']) && $_GET['year']): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h4>Total Sales Amount In
                                <?php if($_GET['month']==1): ?>
                                    January
                                    <?php elseif($_GET['month']==2): ?>February
                                    <?php elseif($_GET['month']==3): ?>March
                                    <?php elseif($_GET['month']==4): ?>April
                                    <?php elseif($_GET['month']==5): ?>May
                                    <?php elseif($_GET['month']==6): ?>June
                                    <?php elseif($_GET['month']==7): ?>July
                                    <?php elseif($_GET['month']==8): ?>August
                                    <?php elseif($_GET['month']==9): ?>September
                                    <?php elseif($_GET['month']==10): ?>October
                                    <?php elseif($_GET['month']==11): ?>November
                                    <?php elseif($_GET['month']==12): ?>December
                                    <?php endif; ?>
                                , <?php echo e($_GET['year']); ?> :  <?php echo e($orders['month_total']); ?></h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $orders['month_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/admin/order/search.blade.php ENDPATH**/ ?>