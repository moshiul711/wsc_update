                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <span class="xm-title badge bg-secondary text-white fw-normal fs-12 badge-pill"> <a href="<?php echo e(route('cart.destroy')); ?>" class="showall-text text-white">Remove All</a> </span>
                                            </div>
                                        </div>
                                    </div>
                                    <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                            <a class="dropdown-item d-flex p-4" href="">
                                                <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php echo e(asset($item->options->image)); ?>"></span>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="dropdown d-md-flex profile-1" >
                                            <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                                ...
                                                <h6 class="text-white">Hello <br><b><?php echo e(Session('customer_name')); ?></b> </h6>
        ...
        <div class="sticky" >
            ...
            <div class="app-sidebar">
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        <li class="slide">
                            <a class="side-menu__item"  href="<?php echo e(route('customer')); ?>" title="Dashboard">
                                <img src="<?php echo e(asset('/')); ?>website/assets/icons/dash.png " alt="">
                                <span class="side-menu__label px-2">Dashboard</span>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item"  href="<?php echo e(route('customer.profile')); ?>" title="Profile">
                                <img src="<?php echo e(asset('/')); ?>website/assets/icons/pp.png " alt="">
                                <span class="side-menu__label px-2">Profile</span>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item"  href="<?php echo e(route('customer.order')); ?>" title="Orders">
                                
                                <img src="<?php echo e(asset('/')); ?>website/assets/icons/order.png " alt="">
                                <span class="side-menu__label px-2">Orders</span>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item"  href="<?php echo e(route('customer.reviews')); ?>" title="Reviews">
                                <img src="<?php echo e(asset('/')); ?>website/assets/icons/review.png " alt="">
                                <span class="side-menu__label px-2">Reviews</span>
                            </a>
                        </li>

                        <li class="slide">
                            <a class="side-menu__item"  href="<?php echo e(route('customer.change.password')); ?>" title="Change Password">
                                <img src="<?php echo e(asset('/')); ?>website/assets/icons/password.png " alt="">
                                    ...
                                    <footer class="main-footer ps-3 pe-3">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 footer1 text-center text-lg-bold">
                                                Copyright © <?php echo e(date('Y')); ?>. All Rights Reserved By<a href="<?php echo e(route('home')); ?>"> Workstation Communication Limited</a>
                                            </div>
                                        </div>
                                    </footer>
                                </div>
...
<script src="<?php echo e(asset('/')); ?>website/assets/plugins/sweet-alert/sweetalert.min.js"></script>
<script src="<?php echo e(asset('/')); ?>website/assets/plugins/sweet-alert/jquery.sweet-alert.js"></script>
...
<?php /**PATH /home/u875892346/domains/wsc.com.bd/public_html/wsc/resources/views/customer/master.blade.php ENDPATH**/ ?>